...
// import { useSettings } from '../../contexts/SettingsContext'; // TODO: Migrate Context
import styles from './Onboarding.module.css';
// import { useAuthStore } from '@asgard/shared/stores'; // TODO: Migrate Store
import igoLogo from '../../assets/igo-logo.svg';

// Mock hooks for migration testing until contexts are moved
const useSettings = () => ({
    storeSettings: { name: '' },
    updateStoreSettings: (settings: any) => console.log('Settings updated:', settings)
});

const useAuthStore = () => ({
    createUser: (user: any) => { console.log('User created:', user); return true; },
    login: (email: string) => console.log('Login:', email),
    allUsers: []
});
            ...
            <div className={styles.onboardingCard}>
                ...
                <aside className={styles.sidebar}>
                    <div className={styles.logoArea}>
                        ...
                        <div className={styles.brand}>BONILO</div>
