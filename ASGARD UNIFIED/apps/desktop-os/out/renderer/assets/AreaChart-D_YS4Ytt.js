...
import { d as clsx, l as isNumber, aD as adaptEventHandlers, a4 as svgPropertiesNoEvents, D as DefaultZIndexes, aE as isClipDot, aF as svgPropertiesAndEventsFromUnknown, Z as ZIndexLayer, L as Layer, g as useAppSelector, ae as selectActiveTooltipIndex, aG as useActiveTooltipDataPoints, aH as isNullish, an as svgPropertiesNoEventsFromUnknown, aI as Global, aJ as getStringSize, ab as mathSign, r as resolveDefaultProps, C as CartesianLabelContextProvider, e as CartesianLabelFromLabelProp, aa as get, aj as adaptEventsOfChild, ao as Text, aK as useChartWidth, aL as useChartHeight, aM as useOffsetInternal, f as useIsPanorama, aN as isPositiveNumber, aO as warn, aP as getCoordinatesOfGrid, aQ as getTicksOfAxis, aR as selectAxisPropsNeededForCartesianGridTicksGenerator, ay as selectXAxisSettings, az as selectYAxisSettings, aS as implicitXAxis, aT as implicitYAxis, aU as usePlotArea, aV as defaultAxisId, n as createSelector, I as selectChartLayout, aW as selectAxisWithScale, aX as selectTicksOfGraphicalItem, aY as selectChartDataWithIndexesIfNotInPanoramaPosition3, aZ as selectChartBaseValue, a_ as selectStackGroups, a$ as getStackSeriesIdentifier, b0 as isCategoricalAxis, b1 as getBandSizeOfAxis, b2 as selectUnfilteredCartesianItems, b3 as propsAreEqual, a5 as RegisterGraphicalItemId, b4 as SetLegendPayload, b5 as SetCartesianGraphicalItem, b6 as getNormalizedStackId, Q as getTooltipNameProp, a9 as SetTooltipEntrySettings, b7 as useChartLayout, b8 as useChartName, B as getValueByDataKey, b9 as getCateCoordinateOfLine, U as useAnimationId, ba as useCartesianChartLayout, W as JavascriptAnimate, X as interpolate, aC as isNan, ak as LabelListFromLabelProp, bb as CartesianLabelListContextProvider, s as svgPropertiesAndEvents, _ as Curve, aB as isWellBehavedNumber, u as useAppDispatch, bc as addXAxis, bd as replaceXAxis, be as removeXAxis, bf as selectAxisViewBox, bg as selectTicksOfAxis, bh as selectXAxisSize, bi as selectXAxisPosition, bj as selectXAxisSettingsNoDefaults, bk as addYAxis, bl as replaceYAxis, bm as removeYAxis, bn as selectYAxisSize, bo as selectYAxisPosition, bp as selectYAxisSettingsNoDefaults, bq as isLabelContentAFunction, br as updateYAxisWidth, aq as RechartsStoreProvider, ar as ChartDataContextProvider, as as ReportMainChartProps, at as ReportChartProps, au as CategoricalChart, av as arrayTooltipSearcher } from "./CategoricalChart-BNQNLo93.js";
function _extends$7() {
...
var Dot = (props) => {
  ...
  if (isNumber(cx) && isNumber(cy) && isNumber(r)) {
    return /* @__PURE__ */ reactExports.createElement("circle", _extends$7({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
function DotItem(_ref) {
  ...
  var _ref2 = dotProps !== null && dotProps !== void 0 ? dotProps : {}, {
    points
  } = _ref2, props = _objectWithoutProperties$6(_ref2, _excluded$6);
  return /* @__PURE__ */ reactExports.createElement(Dot, _extends$6({}, props, {
...
function Dots(_ref3) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    zIndex
  }, /* @__PURE__ */ reactExports.createElement(Layer, _extends$6({
    className
  }, layerProps), dots));
}
...
var createLabeledScales = (options) => {
  var scales = Object.keys(options).reduce((res, key) => _objectSpread$4(_objectSpread$4({}, res), {}, {
    [key]: ScaleHelper.create(options[key])
  }), {});
  return _objectSpread$4(_objectSpread$4({}, scales), {}, {
    apply(coord) {
      var {
        bandAware,
        position
...
var _excluded$5 = ["axisLine", "width", "height", "className", "hide", "ticks", "axisType"];
...
var _excluded$4 = ["x1", "y1", "x2", "y2", "key"], _excluded2$4 = ["offset"], _excluded3 = ["xAxisId", "yAxisId"], _excluded4 = ["xAxisId", "yAxisId"];
...
function LineItem(_ref) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    var {
      ...
      y2,
      key
    } = lineItemProps, others = _objectWithoutProperties$4(lineItemProps, _excluded$4);
    var _ref2 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(others)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
      offset: __
    } = _ref2, restOfFilteredProps = _objectWithoutProperties$4(_ref2, _excluded2$4);
...
function HorizontalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$4(props, _excluded3);
...
function VerticalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$4(props, _excluded4);
...
function StaticArea(_ref4) {
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ reactExports.createElement(Layer, {
  ...
  }, /* @__PURE__ */ reactExports.createElement(Curve, _extends$3({}, propsWithEvents, {
    id,
    points,
    connectNulls,
    type,
  ...
  })), stroke !== "none" && /* @__PURE__ */ reactExports.createElement(Curve, _extends$3({}, allOtherProps, {
    ...
    fill: "none",
    points
  })), stroke !== "none" && isRange && /* @__PURE__ */ reactExports.createElement(Curve, _extends$3({}, allOtherProps, {
    className: "recharts-area-curve",
    layout,
    type,
    connectNulls,
...
function AreaImpl(props) {
  ...
  var _resolveDefaultProps = resolveDefaultProps(props, defaultAreaProps), {
    ...
    xAxisId,
    yAxisId
  } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$3(_resolveDefaultProps, _excluded2$3);
  ...
  return /* @__PURE__ */ reactExports.createElement(AreaWithState, _extends$3({}, everythingElse, {
    activeDot,
    animationBegin,
    animationDuration,
    animationEasing,
...
function AreaFn(outsideProps) {
  ...
  }), /* @__PURE__ */ reactExports.createElement(AreaImpl, _extends$3({}, props, {
    id
  }))));
}
...
var _excluded$1 = ["dangerouslySetInnerHTML", "ticks", "scale"], _excluded2$1 = ["id", "scale"];
function _extends$2() {
...
var XAxisImpl = (props) => {
  ...
  var {
    ...
    ticks,
    scale: del
  } = props, allOtherProps = _objectWithoutProperties$1(props, _excluded$1);
  var {
    id,
    scale: del2
  } = synchronizedSettings, restSynchronizedSettings = _objectWithoutProperties$1(synchronizedSettings, _excluded2$1);
...
var _excluded = ["dangerouslySetInnerHTML", "ticks", "scale"], _excluded2 = ["id", "scale"];
function _extends$1() {
...
var YAxisImpl = (props) => {
  ...
  var {
    ...
    ticks,
    scale: del
  } = props, allOtherProps = _objectWithoutProperties(props, _excluded);
  var {
    id,
    scale: del2
  } = synchronizedSettings, restSynchronizedSettings = _objectWithoutProperties(synchronizedSettings, _excluded2);
