...
import { Product, Customer, Sale, SaleItem } from '@core';
...
export const seedMockData = async () => {
    ...
    const { useProductsStore, useCustomersStore, useSalesStore } = await import('@core/stores');
...
export const clearMockData = async () => {
    const { useProductsStore, useCustomersStore } = await import('@core/stores');
