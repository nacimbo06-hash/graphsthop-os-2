import { r as reactExports, g as getDefaultExportFromCjs, a as requireReact, f as reactDomExports, h as React } from "./vendor-react-Df__x13C.js";
import { r as requireShim } from "./vendor-i18n-DeCNyroL.js";
function r(e) {
  var t, f, n = "";
...
var _excluded$9 = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function _extends$d() {
...
var Surface = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  var {
    ...
    title,
    desc
  } = props, others = _objectWithoutProperties$9(props, _excluded$9);
  var svgView = viewBox || {
    width,
    height,
    x: 0,
  ...
  return /* @__PURE__ */ reactExports.createElement("svg", _extends$d({}, svgPropertiesAndEvents(others), {
...
var Layer = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  var {
    children,
    className
  } = props, others = _objectWithoutProperties$8(props, _excluded$8);
  var layerClass = clsx("recharts-layer", className);
  return /* @__PURE__ */ reactExports.createElement("g", _extends$c({
    className: layerClass
...
function resolveDefaultProps(realProps, defaultProps) {
  var resolvedProps = _objectSpread$o({}, realProps);
  var dp = defaultProps;
...
var DefaultTooltipContent = (props) => {
  ...
  var renderContent2 = () => {
    if (payload && payload.length) {
      ...
      var items = (itemSorter ? sortBy(payload, itemSorter) : payload).map((entry, i) => {
        ...
        var finalItemStyle = _objectSpread$k({
          display: "block",
          paddingTop: 4,
          paddingBottom: 4,
  ...
  var finalStyle = _objectSpread$k({
    margin: 0,
    padding: 10,
    backgroundColor: "#fff",
  ...
  var finalLabelStyle = _objectSpread$k({
    margin: 0
  }, labelStyle);
  ...
  return /* @__PURE__ */ reactExports.createElement("div", _extends$a({
    className: wrapperCN,
    style: finalStyle
...
class TooltipBoundingBox extends reactExports.PureComponent {
  constructor() {
    ...
    _defineProperty$l(this, "handleKeyDown", (event) => {
      if (event.key === "Escape") {
  ...
  render() {
    ...
    var positionStyles = hasPortalFromProps ? {} : _objectSpread$j(_objectSpread$j({
    ...
    var outerStyle = _objectSpread$j(_objectSpread$j({}, positionStyles), {}, {
      visibility: !this.state.dismissed && active && hasPayload ? "visible" : "hidden"
    }, wrapperStyle);
    return (
...
var getPath$1 = (_ref2) => {
  ...
  if (Array.isArray(baseLine)) {
    var areaPoints = points.map((entry, index) => _objectSpread$i(_objectSpread$i({}, entry), {}, {
      base: baseLine[index]
    }));
    if (layout === "vertical") {
...
var Curve = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$9({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
var mapObject = (fn, obj) => Object.keys(obj).reduce((res, key) => _objectSpread$g(_objectSpread$g({}, res), {}, {
  [key]: fn(key, obj[key])
}), {});
...
function createStepperUpdate(from2, to2, easing, interKeys, render, timeoutController) {
  var preTime;
  var stepperStyle = interKeys.reduce((res, key) => _objectSpread$f(_objectSpread$f({}, res), {}, {
    [key]: {
      from: from2[key],
      velocity: 0,
      to: to2[key]
  ...
  var stepperUpdate = (now) => {
    ...
    render(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, from2), to2), getCurrStyle()));
    preTime = now;
...
function createTimingUpdate(from2, to2, easing, duration, interKeys, render, timeoutController) {
  ...
  var timingStyle = interKeys.reduce((res, key) => {
    ...
    return _objectSpread$f(_objectSpread$f({}, res), {}, {
  ...
  var timingUpdate = (now) => {
    ...
    render(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, from2), to2), currStyle));
    if (t < 1) {
      stopAnimation = timeoutController.setTimeout(timingUpdate);
    } else {
      var finalStyle = mapObject((key, val) => alpha(...val, easing(1)), timingStyle);
      render(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, from2), to2), finalStyle));
    }
  };
  return () => {
    stopAnimation = timeoutController.setTimeout(timingUpdate);
...
const configUpdate = (from2, to2, easing, duration, render, timeoutController) => {
  ...
  if (easing == null) {
    return () => {
      render(_objectSpread$f(_objectSpread$f({}, from2), to2));
      return () => {
      };
    };
  }
...
var _excluded$6 = ["radius"], _excluded2$3 = ["radius"];
...
var Rectangle = (rectangleProps) => {
  ...
  if (!isUpdateAnimationActive) {
    var _svgPropertiesAndEven = svgPropertiesAndEvents(props), {
      radius: _
    } = _svgPropertiesAndEven, otherPathProps = _objectWithoutProperties$6(_svgPropertiesAndEven, _excluded$6);
    return /* @__PURE__ */ reactExports.createElement("path", _extends$7({}, otherPathProps, {
      x: round$1(x2),
      y: round$1(y2),
      width: round$1(width),
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    var _svgPropertiesAndEven2 = svgPropertiesAndEvents(props), {
      radius: _2
    } = _svgPropertiesAndEven2, otherPathProps2 = _objectWithoutProperties$6(_svgPropertiesAndEven2, _excluded2$3);
    return /* @__PURE__ */ reactExports.createElement("path", _extends$7({}, otherPathProps2, {
      radius: typeof radius === "number" ? radius : void 0,
      className: layerClass,
      d: getRectanglePath(currX, currY, currWidth, currHeight, radius),
      ref: pathRef,
      style: _objectSpread$e(_objectSpread$e({}, animationStyle), props.style)
    }));
  });
};
...
var Sector = (sectorProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$6({}, svgPropertiesAndEvents(props), {
    className: layerClass,
    d: path
  }));
};
...
var selectAxisWithScale = createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
  ...
  return _objectSpread$c(_objectSpread$c({}, axis), {}, {
    scale
  });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
  ...
  if (hasBeenActivePreviously(appropriateMouseInteraction)) {
    if (activeFromProps) {
      return _objectSpread$b(_objectSpread$b({}, appropriateMouseInteraction), {}, {
        active: true
      });
    }
  ...
  return _objectSpread$b(_objectSpread$b({}, noInteraction), {}, {
  ...
  return tooltipPayloadConfigurations.reduce((agg, _ref2) => {
    ...
    if (Array.isArray(tooltipPayload)) {
      tooltipPayload.forEach((item) => {
        var newSettings = _objectSpread$a(_objectSpread$a({}, settings), {}, {
...
var useTooltipAxisBandSize = () => {
  ...
  return getBandSizeOfAxis(_objectSpread$9(_objectSpread$9({}, tooltipAxis), {}, {
...
var seed = {};
var initialState$8 = {
  zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current2) => _objectSpread$7(_objectSpread$7({}, acc), {}, {
    [current2]: {
      element: void 0,
...
function CursorInternal(props) {
  ...
  var cursorProps = _objectSpread$6(_objectSpread$6(_objectSpread$6(_objectSpread$6({
    stroke: "#ccc",
    pointerEvents: "none"
...
function Cursor(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(CursorInternal, _extends$5({}, props, {
    offset,
    layout,
    tooltipAxisBandSize,
    chartName
      ...
      if (syncMethod === "index") {
        ...
        if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
          var _action$payload$coord = action.payload.coordinate, {
            x: _x,
            y: _y
          } = _action$payload$coord, otherCoordinateProps = _objectWithoutProperties$5(_action$payload$coord, _excluded$5);
          var {
            x: sourceX,
            y: sourceY,
            width: sourceWidth,
          ...
          var scaledCoordinate = _objectSpread$5(_objectSpread$5({}, otherCoordinateProps), {}, {
            x: viewBox.x + (sourceWidth ? (_x - sourceX) / sourceWidth : 0) * viewBox.width,
            y: viewBox.y + (sourceHeight ? (_y - sourceY) / sourceHeight : 0) * viewBox.height
          });
          dispatch(_objectSpread$5(_objectSpread$5({}, action), {}, {
            payload: _objectSpread$5(_objectSpread$5({}, action.payload), {}, {
...
class LRUCache {
  constructor(maxSize) {
    _defineProperty$5(this, "cache", /* @__PURE__ */ new Map());
...
var currentConfig = _objectSpread$3({}, defaultConfig);
...
_defineProperty$3(DecimalCSS, "NaN", new _DecimalCSS(NaN, ""));
...
var _excluded$4 = ["x", "y", "lineHeight", "capHeight", "fill", "scaleToFit", "textAnchor", "verticalAnchor"], _excluded2$2 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$4() {
...
var Text = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  var _resolveDefaultProps = resolveDefaultProps(outsideProps, textDefaultProps), {
    ...
    textAnchor,
    verticalAnchor
  } = _resolveDefaultProps, props = _objectWithoutProperties$4(_resolveDefaultProps, _excluded$4);
  ...
  var {
    ...
    className,
    breakAll
  } = props, textProps = _objectWithoutProperties$4(props, _excluded2$2);
  ...
  return /* @__PURE__ */ reactExports.createElement("text", _extends$4({}, svgPropertiesAndEvents(textProps), {
    ref,
    x: x2,
    y: y2,
...
var _excluded$3 = ["labelRef"], _excluded2$1 = ["content"];
...
var renderRadialLabel = (labelProps, position, label, attrs, viewBox) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("text", _extends$3({}, attrs, {
...
function Label(outerProps) {
  ...
  var propsWithViewBox = _objectSpread$2(_objectSpread$2({}, props), {}, {
    viewBox
  });
  if (/* @__PURE__ */ reactExports.isValidElement(content)) {
    var {
      labelRef: _
    } = propsWithViewBox, propsWithoutLabelRef = _objectWithoutProperties$3(propsWithViewBox, _excluded$3);
    return /* @__PURE__ */ reactExports.cloneElement(content, propsWithoutLabelRef);
  }
  if (typeof content === "function") {
    var {
      content: _2
    } = propsWithViewBox, propsForContent = _objectWithoutProperties$3(propsWithViewBox, _excluded2$1);
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    zIndex: props.zIndex
  }, /* @__PURE__ */ reactExports.createElement(Text, _extends$3({
    ref: labelRef,
...
var parseLabel = (label, viewBox, labelRef) => {
  ...
  if (label && typeof label === "object") {
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$3({}, label, {
      key: "label-implicit"
    }, commonProps));
  }
  return null;
...
var _excluded$2 = ["valueAccessor"], _excluded2 = ["dataKey", "clockWise", "id", "textBreakAll", "zIndex"];
function _extends$2() {
...
function LabelList(_ref2) {
  ...
  } = _ref2, restProps = _objectWithoutProperties$2(_ref2, _excluded$2);
  var {
    dataKey,
    clockWise,
    id,
    textBreakAll,
    zIndex
  } = restProps, others = _objectWithoutProperties$2(restProps, _excluded2);
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    ...
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$2({
...
function LabelListFromLabelProp(_ref2) {
  ...
  if (typeof label === "object") {
    return /* @__PURE__ */ reactExports.createElement(LabelList, _extends$2({
      key: "labelList-implicit"
    }, label, {
...
export {
  Sector as $,
  combineAppliedValues as A,
  getValueByDataKey as B,
  CartesianLabelContextProvider as C,
  DefaultZIndexes as D,
  selectAllErrorBarSettings as E,
  combineDomainOfAllAppliedNumericalValuesIncludingErrorValues as F,
  selectDomainDefinition as G,
  selectDomainFromUserPreference as H,
  selectChartLayout as I,
  combineNumericalDomain as J,
  selectStackOffsetType as K,
  Layer as L,
  combineAxisDomain as M,
  selectRealScaleType as N,
  combineNiceTicks as O,
  combineAxisDomainWithNiceTicks as P,
  getTooltipNameProp as Q,
  ResponsiveContainer as R,
  selectChartOffsetInternal as S,
  Tooltip as T,
  useAnimationId as U,
  getTransitionVal as V,
  JavascriptAnimate as W,
  interpolate$1 as X,
  roundTemplateLiteral as Y,
  ZIndexLayer as Z,
  Curve as _,
  addDot as a,
  getStackSeriesIdentifier as a$,
  Rectangle as a0,
  setActiveMouseOverItemIndex as a1,
  mouseLeaveItem as a2,
  setActiveClickItemIndex as a3,
  svgPropertiesNoEvents as a4,
  RegisterGraphicalItemId as a5,
  SetPolarGraphicalItem as a6,
  findAllByType as a7,
  SetPolarLegendPayload as a8,
  SetTooltipEntrySettings as a9,
  useViewBox as aA,
  isWellBehavedNumber as aB,
  isNan as aC,
  adaptEventHandlers as aD,
  isClipDot as aE,
  svgPropertiesAndEventsFromUnknown as aF,
  useActiveTooltipDataPoints as aG,
  isNullish as aH,
  Global as aI,
  getStringSize as aJ,
  useChartWidth as aK,
  useChartHeight as aL,
  useOffsetInternal as aM,
  isPositiveNumber as aN,
  warn as aO,
  getCoordinatesOfGrid as aP,
  getTicksOfAxis as aQ,
  selectAxisPropsNeededForCartesianGridTicksGenerator as aR,
  implicitXAxis as aS,
  implicitYAxis as aT,
  usePlotArea as aU,
  defaultAxisId as aV,
  selectAxisWithScale as aW,
  selectTicksOfGraphicalItem as aX,
  selectChartDataWithIndexesIfNotInPanoramaPosition3 as aY,
  selectChartBaseValue as aZ,
  selectStackGroups as a_,
  get$1 as aa,
  mathSign as ab,
  polarToCartesian as ac,
  PolarLabelListContextProvider as ad,
  selectActiveTooltipIndex as ae,
  selectActiveTooltipDataKey as af,
  selectActiveTooltipGraphicalItemId as ag,
  DATA_ITEM_GRAPHICAL_ITEM_ID_ATTRIBUTE_NAME as ah,
  DATA_ITEM_INDEX_ATTRIBUTE_NAME as ai,
  adaptEventsOfChild as aj,
  LabelListFromLabelProp as ak,
  getMaxRadius as al,
  getPercentValue as am,
  svgPropertiesNoEventsFromUnknown as an,
  Text as ao,
  updatePolarOptions as ap,
  RechartsStoreProvider as aq,
  ChartDataContextProvider as ar,
  ReportMainChartProps as as,
  ReportChartProps as at,
  CategoricalChart as au,
  arrayTooltipSearcher as av,
  addLine as aw,
  removeLine as ax,
  selectXAxisSettings as ay,
  selectYAxisSettings as az,
  removeDot as b,
  isCategoricalAxis as b0,
  getBandSizeOfAxis as b1,
  selectUnfilteredCartesianItems as b2,
  propsAreEqual as b3,
  SetLegendPayload as b4,
  SetCartesianGraphicalItem as b5,
  getNormalizedStackId as b6,
  useChartLayout as b7,
  useChartName as b8,
  getCateCoordinateOfLine as b9,
  useCartesianChartLayout as ba,
  CartesianLabelListContextProvider as bb,
  addXAxis as bc,
  replaceXAxis as bd,
  removeXAxis as be,
  selectAxisViewBox as bf,
  selectTicksOfAxis as bg,
  selectXAxisSize as bh,
  selectXAxisPosition as bi,
  selectXAxisSettingsNoDefaults as bj,
  addYAxis as bk,
  replaceYAxis as bl,
  removeYAxis as bm,
  selectYAxisSize as bn,
  selectYAxisPosition as bo,
  selectYAxisSettingsNoDefaults as bp,
  isLabelContentAFunction as bq,
  updateYAxisWidth as br,
  useClipPathId as c,
  clsx as d,
  CartesianLabelFromLabelProp as e,
  useIsPanorama as f,
  useAppSelector as g,
  selectAxisScale as h,
  isNumOrStr as i,
  Label as j,
  constant$1 as k,
  isNumber as l,
  ...
  pickAxisId as o,
  pickAxisType as p,
  itemAxisPredicate as q,
  resolveDefaultProps as r,
  svgPropertiesAndEvents as s,
  selectBaseAxis as t,
  useAppDispatch as u,
  combineGraphicalItemsSettings as v,
  withPath as w,
  combineGraphicalItemsData as x,
  selectChartDataAndAlwaysIgnoreIndexes as y,
  combineDisplayedData as z
};
